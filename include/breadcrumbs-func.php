...
function breadcrumbs() {
	...
	$before         = '<li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">'; // тег перед текущей "крошкой"
	...
	if ( is_home() || is_front_page() ) {
		...
		if ( is_category() ) {
			...
			if ( get_post_type() != 'post' ) {
				...
				if ( $show_current ) echo $sep . $before . get_the_title() . sprintf($after, $position);
				elseif ( $show_last_sep ) echo $sep;
			} else {
